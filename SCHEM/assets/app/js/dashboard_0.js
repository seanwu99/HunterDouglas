var Dashboard = function () {
    var e = function (e, t, a, r) {
            ...
            var o = {
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{display: !1, gridLines: !1, scaleLabel: {display: !0, labelString: "Value"}, ticks: {beginAtZero: !0}}]
                    },
        ...
        var e = {
            ...
            datasets: [{backgroundColor: mUtil.getColor("success"), data: [15, 20, 25, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20]}, {
        ...
        if (0 != $("#m_chart_profit_share").length) {
            var e = new Chartist.Pie("#m_chart_profit_share", {
                series: [{value: 32, className: "custom", meta: {color: mUtil.getColor("brand")}}, {
                    value: 32,
                    className: "custom",
                    meta: {color: mUtil.getColor("accent")}
                }, {value: 36, className: "custom", meta: {color: mUtil.getColor("warning")}}], labels: [1, 2, 3]
        ...
        0 != $("#m_chart_support_tickets2").length && new Chartist.Pie("#m_chart_support_tickets2", {
            ...
            }, {value: 32, className: "custom", meta: {color: mUtil.getColor("accent")}}, {value: 36, className: "custom", meta: {color: mUtil.getColor("warning")}}],
            labels: [1, 2, 3]
        ...
        if (0 != $("#m_chart_adwords_stats").length) {
            ...
            var a = {
                ...
                options: {
                    ...
                    scales: {
                        xAxes: [{display: !1, gridLines: !1, scaleLabel: {display: !0, labelString: "Month"}}],
                        yAxes: [{stacked: !0, display: !1, gridLines: !1, scaleLabel: {display: !0, labelString: "Value"}, ticks: {beginAtZero: !0}}]
                    },
                    elements: {line: {tension: 1e-7}, point: {radius: 4, borderWidth: 12}},
                    layout: {padding: {left: 0, right: 0, top: 10, bottom: 0}}
                }
        ...
        if (0 !== $("#m_datatable_latest_orders").length) $(".m_datatable").mDatatable({
            ...
            filterable: !1,
            pagination: !0,
            columns: [{field: "RecordID", title: "#", sortable: !1, width: 40, selector: {class: "m-checkbox--solid m-checkbox--brand"}, textAlign: "center"}, {
                field: "OrderID",
                title: "Order ID",
                sortable: "asc",
                filterable: !1,
            ...
            }, {field: "ShipName", title: "Ship Name", width: 150, responsive: {visible: "lg"}}, {field: "ShipDate", title: "Ship Date"}, {
                field: "Status",
                title: "Status",
                width: 100,
                template: function (e) {
